...
import 'package:pharmageddon_mobile/controllers/reset_password_cubit/reset_password_cubit.dart';
import 'package:pharmageddon_mobile/controllers/reset_password_cubit/reset_password_state.dart';
          ...
          return Container(
            ...
            child: Scaffold(
              ...
              appBar: CustomAppBar(
                ...
                title: AppStrings.resetPassword.tr,showOptions: false,
              ).build(),
              body: Form(
                key: cubit.formKey,
                child: ListView(
